...
public interface CalcPrecoPrazoWSSoap {
    ...
    @RequestWrapper(localName = "CalcPrecoPrazoRestricao", targetNamespace = "http://tempuri.org/", className = "br.com.caelum.correios.ws.CalcPrecoPrazoRestricao")
    @ResponseWrapper(localName = "CalcPrecoPrazoRestricaoResponse", targetNamespace = "http://tempuri.org/", className = "br.com.caelum.correios.ws.CalcPrecoPrazoRestricaoResponse")
    ...
    @RequestWrapper(localName = "CalcPrazoRestricao", targetNamespace = "http://tempuri.org/", className = "br.com.caelum.correios.ws.CalcPrazoRestricao")
    @ResponseWrapper(localName = "CalcPrazoRestricaoResponse", targetNamespace = "http://tempuri.org/", className = "br.com.caelum.correios.ws.CalcPrazoRestricaoResponse")
    ...
    @RequestWrapper(localName = "CalcPrecoFAC", targetNamespace = "http://tempuri.org/", className = "br.com.caelum.correios.ws.CalcPrecoFAC")
    @ResponseWrapper(localName = "CalcPrecoFACResponse", targetNamespace = "http://tempuri.org/", className = "br.com.caelum.correios.ws.CalcPrecoFACResponse")
